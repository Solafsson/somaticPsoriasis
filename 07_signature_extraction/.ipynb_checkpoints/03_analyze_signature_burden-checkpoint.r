...
sample_meta <- read.table("/Users/so11/phd/psoriasis/sample_info/sample_meta_wrongNames_first148.txt", h=T, stringsAsFactors = F)
...
sigNames <- c("Unassigned","SBS7b","PUVA", "New1", "SBS7a",
              "SBS2","New2", "SBS13")
