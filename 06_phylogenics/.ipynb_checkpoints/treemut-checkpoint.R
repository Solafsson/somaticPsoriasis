...
.libPaths("/lustre/scratch114/projects/crohns/somatic_ibd_p1/R_packages_farm5_R3.6_install/")
  ...
  if(system("uname",intern = TRUE)=="Darwin"){
    dyn.load("/nfs/users/nfs_s/so11/phd/psoriasis/bsub_jupyter_lab/psoriasis/06_phylogenics/treemut.Darwin.so")
  }else{
    dyn.load("/nfs/users/nfs_s/so11/phd/psoriasis/bsub_jupyter_lab/psoriasis/06_phylogenics/treemut.so")
  }
}
  ...
  load_lib=function(){
  if(system("uname",intern = TRUE)=="Darwin"){
    dyn.load("/Users/so11/phd/somatic_ibd_p1/manuscript/somaticIBD/phylogenics/treemut.Darwin.so")
  }else{
    dyn.load("/Users/so11/phd/somatic_ibd_p1/manuscript/somaticIBD/phylogenics/treemut.so")
  }
}
}
