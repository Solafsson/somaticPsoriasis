...
## This script contains a slightly modified dndscv function. The modifications allow us to
## consider nonsense and splice mutations together under the term "truncating mutations"
